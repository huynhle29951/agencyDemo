...
export default () => (
  <Layout>
    ...
    <SectionThree>
      <FlexBoxIndex>
        <div className="image">
          <img src="pic01.jpg" alt="pc01" />
        </div>
        <div className="text__section3">
          <GenericH2>Website Development</GenericH2>
          <GenereicPara lessSize lessSpacing>
            We hand ocde beautiful websites using HTML5, CSS3, JS because they
            are fully customizable and efficient. No WordPress website here.
          </GenereicPara>
        </div>
      </FlexBoxIndex>
